 ...
 * @returns string
 */
const renderYouHaveRevised_N_Words = () => `You've revised ${wordCount} words today`
 ...
 * @returns string
 */
const renderYouAreAddingExistingWord = (word) => `You're adding the following word \\- __${word.English}__
